...
import com.example.administrator.androidroomdemo.adapter.CategoryAdapter;
...
public class EditNoteActivity extends AppCompatActivity implements OnClickListener, OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /** 接收 從MainActivity傳遞過來的資料 */
        Intent intent = getIntent();
        if (intent.hasExtra(EXTRA_NOTE_ID)) {                                                     // 判斷传递过来的intent值的key值中, 是否包含EXTRA_NOTE_ID这个元素
    ...
    private void saveNote() {
        ...
        new AsyncTask<Note, Void, Void>() {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                if (MainActivity.isHasBeenRecreate == false) {
                    MainActivity.isTheNotificationRecreateFromEditNoteActivity = true;
                }
